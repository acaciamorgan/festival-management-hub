-- Multi-Year Archive System Migration (Safe Version)
-- Drops and recreates festival_settings if it exists
-- Adds festival_year to all tables and backfills with 2025

BEGIN;

-- Drop and recreate festival_settings table to ensure clean schema
