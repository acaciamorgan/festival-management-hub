-- Complete Archive Function including Festival Settings
...
BEGIN
  ...
  -- Archive Festival Settings FIRST - THIS IS THE NEW PART
  ...
  -- Prepare statistics (UPDATED TO INCLUDE SETTINGS)
