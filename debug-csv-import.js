// Debug the actual CSV import logic with console logging
...
// Test the EXACT scenario from your CSV
console.log("=== TESTING CSV IMPORT SCENARIO ===")

const csvTitle = "Reckoning of Erin Morrigan, The"
const dbTitles = [
...
console.log("Testing if CSV title matches any DB title:")
const result = findBestTitleMatch(csvTitle, dbTitles)
console.log(`\nFINAL RESULT: ${result ? `FOUND "${result}"` : 'NOT FOUND'}`)