-- Update Programming Pipeline schema to match CSV headers exactly
...
-- Programming films table - matches CSV structure exactly
CREATE TABLE programming_films (
    ...
    runtime INTEGER, -- new field for minutes
